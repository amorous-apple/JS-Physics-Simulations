...
function b3Height_display() {
	let b3height = Ball3.pos.y;
	ctx.fillText("Height of the top ball: " + b3height.toFixed(4), 30, 30);
}
...
// Places a ball a height above the ground.
let Ball1 = new Ball(canvas.clientWidth / 2, 720 - height - r1, r1, m1);

// Places a ball above the first one.
let Ball2 = new Ball(canvas.clientWidth / 2, 720 - height - 2 * r1 - r2, r2, m2);

// Places a ball above the second one.
let Ball3 = new Ball(canvas.clientWidth / 2, 720 - height - 2 * (r1 + r2) - r3, r3, m3);
